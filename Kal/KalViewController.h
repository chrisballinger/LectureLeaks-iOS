...
@interface KalViewController : UIViewController <KalViewDelegate, KalDataSourceCallbacks>
{
  ...
  unsigned int numberOfAppending;
}
...
@property (nonatomic, assign) unsigned int numberOfAppending;
...
- (NSDate *)endOfDate;                              // Return the date added numberOfDays from selectedDate.
@end
